...
class TestPreCondition:
    def __init__(self, preConditionData):
        # precondition基础属性初始
        self.step = preConditionData.get('step')
        self.desc = preConditionData.get('desc')
        self.curl = preConditionData.get('curl') + ' --silent'
        self.expect = preConditionData.get('expect')
        self.memo = preConditionData.get('memo')
